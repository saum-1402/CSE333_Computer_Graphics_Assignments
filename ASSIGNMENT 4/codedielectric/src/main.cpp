...
int main(int, char**)
{
    ...
    Material *ms = new Material(world);
    ...
    Material *mt = new Material(world);
    mt->color = Color(1.0, 0.5, 0.2); //orange color
    // mt->color = Color(0.753, 0.753, 0.753);
    mt->ka = 0.1;
    mt->kd = 0.6;
    mt->ks = 0.9;
    mt->kr = 0.4;
    ...
    Object *sphere = new Sphere(Vector3D(2, 0, -10), 2, ms);
    world->addObject(sphere);
    // sphere->isSolid = false; //make sphere dielectric
    //commenting above line will make the code give a solid sphere

    // Object *triangle = new Triangle(Vector3D(0.0, 8.0, -25.0), Vector3D(-10.0,-8.0, -16.0), Vector3D(10.0, -8.0, -25.0), mt);

    Object *triangle = new Triangle(Vector3D(3.0, 8.0, -25.0), Vector3D(-7.0, -8.0, -25.0), Vector3D(13.0, -8.0, -15.0), mt);
